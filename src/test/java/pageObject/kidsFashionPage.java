...
public class kidsFashionPage {
	
	WebDriver ldriver;
	
	public kidsFashionPage(WebDriver rdriver)
	{
		ldriver=rdriver;
	...
	@FindBy(xpath="//*[@id=\"container\"]/div/div[2]/div/div/div[3]/a/div[2]/div[2]/div[2]/div/div/div[1]/a[9]")
	@CacheLookup
	WebElement btnKids;
