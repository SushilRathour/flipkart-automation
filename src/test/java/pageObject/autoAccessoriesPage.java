...
public class autoAccessoriesPage {
	
	WebDriver ldriver;
	
	public autoAccessoriesPage(WebDriver rdriver)
	{
		ldriver=rdriver;
	...
	@FindBy(xpath="//*[@id=\"container\"]/div/div[2]/div/div/div[9]/a/div[2]/div[2]/div[2]/div/div/div[1]/a[11]")
	@CacheLookup
	WebElement btnAuto;
