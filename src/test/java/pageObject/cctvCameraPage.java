...
public class cctvCameraPage {
	
	WebDriver ldriver;
	
	public cctvCameraPage(WebDriver rdriver)
	{
		ldriver=rdriver;
	...
	@FindBy(xpath="//body/div[@id='container']/div[1]/div[3]/div[2]/div[2]/div[2]/div[1]/div[3]/a[1]/div[1]/img[2]")
	@CacheLookup
